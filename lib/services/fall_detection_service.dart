...
class FallDetectionService {
  ...
  // ปรับปรุง Thresholds
  static const double accelerationThreshold = 23.0; // แรง G ที่บ่งบอกการล้ม
  static const double gyroscopeThreshold = 11.0; // ความเร็วการหมุน (rad/s)
  static const double stabilityThreshold = 2.0; // threshold สำหรับความนิ่ง

  // ตัวแปรสำหรับการตรวจสอบรูปแบบการล้ม
  ...
  static const int cooldownPeriod = 20000; // 20 วินาที
  ...
  void stopMonitoring() {
    ...
    print("FallDetectionService: หยุดการตรวจจับการล้ม");
  }
}